...
let Informacion = {
    ...
    fun: {
        loadDataToForm: (data) => {
            ...
            Informacion.view.formData.informacion_pais.value = data.informacion_pais;
            Informacion.view.formData.informacion_provincia.value = data.informacion_provincia;
        ...
        setEditMode: (bool) => {
            ...
            Informacion.view.formData.informacion_pais.disabled = !bool;
            Informacion.view.formData.informacion_provincia.disabled = !bool;
        ...
        submitForm: () => {
            if (
                ...
                Informacion.view.formData.informacion_pais.value == "" ||
                Informacion.view.formData.informacion_provincia.value == "" ||
                ...
                return;
            } else if (!isTelefono(Informacion.view.formData.informacion_telefono.value)) {
